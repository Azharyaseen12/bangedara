      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-bold text-xl">Bangedara</span>
            </div>
              ...
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  {footerLinks.product.map((item) => (
                    <li key={item.name}>
                      <Link href={item.href} className="text-base text-gray-300 hover:text-emerald-400 transition-colors duration-200">
                        {item.name}
                      </Link>
                    </li>
                  ))}
        ...
        <div className="mt-12 border-t border-gray-700 pt-8">
          <p className="text-base text-gray-400 text-center">
            &copy; {currentYear} Bangedara. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
